...
const images = [{ url: "/images/hotels/7.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">DoubleTree by Hilton</p>
        <p className="text-black tw-text-md mb-4 text-decoration-underline">
          Almaty, Kazakhstan
        </p>
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[7]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Find us in the foothills of the Trans-Ili Alatau Mountains, just
              five minutes from Baikonur Metro Station. Our hotel features a spa
              with private treatment rooms and a Turkish hammam, as well as an
              indoor pool. We are within three kilometers of Kunayev Museum and
              Art Meken Gallery, and Central Almaty is six kilometers away.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$105</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$105</p>
              </div>
              <div>
                <Button

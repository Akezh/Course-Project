...
const images = [{ url: "/images/hotels/3.png" }];
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Set in the Expo 2017 Astana complex, this contemporary hotel is 6
              km from Baiterek Tower and 9 km from Nursultan Nazarbayev
              International Airport. Quarters range from sleek rooms to suites
              offering separate sitting areas, balconies, lounge access and/or
              kitchens. All offer free Wi-Fi, flat-screen TVs, minibars, 24-hour
              room service, and tea and coffeemakers.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$73.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$73.5</p>
              </div>
              <div>
                <Button

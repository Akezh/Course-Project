...
const images = [{ url: "/images/hotels/2.png" }];
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Set on the Isham River in the Arman leisure and business complex,
              this upscale hotel occupies a striking modern building. Its 5 km
              from both Bayterek observation tower and the futuristic Khan
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$80.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$80.5</p>
              </div>
              <div>
                <Button

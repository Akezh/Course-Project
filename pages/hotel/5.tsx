...
const images = [{ url: "/images/hotels/5.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">
        ...
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[5]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            <p className="text-black tw-text-3xl my-3">
              Luxury stay in Astana, Kazakhstan
            </p>
            <p className="text-black tw-text-lg tw-mb-4">
              Set in the business district, this upscale hotel is 4 km from the
              elegant Astana Opera house and 5 km from the observation tower at
              the Bayterek monument. Casual rooms with colorful decor provide
              free Wi-Fi, flat-screen TVs and safes. Upgraded rooms add
              minibars, while suites have separate living areas, and tea and
              coffeemakers, plus city views. Room service is offered.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$66.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$66.5</p>
              </div>
              <div>
                <Button

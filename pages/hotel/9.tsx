...
const images = [{ url: "/images/hotels/9.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">The Ritz-Carlton Almaty</p>
        <p className="text-black tw-text-md mb-4 text-decoration-underline">
          Almaty, Kazakhstan
        </p>
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[9]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Almaty is the business and cultural center of Kazakhstan and a
              city that has long appealed to those of a nomadic nature. With
              sumptuous accommodation, superior service and a prime location in
              the city center, The Ritz-Carlton, Almaty offers a luxury hotel
              experience that stirs every sense. Alight from the sky elevator
              into the 30th floor lobby and receive a splendid welcome,
              accentuated by the awe-inspiring views that surround you.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$101.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$101.5</p>
              </div>
              <div>
                <Button

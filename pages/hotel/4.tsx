...
const images = [{ url: "/images/hotels/4.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">The Ritz-Carlton Astana</p>
        <p className="text-black tw-text-md mb-4 text-decoration-underline">
          Astana, Kazakhstan
        </p>
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[4]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              In a sleek high-rise building, this chic luxury hotel is 2 km from
              the P-3 Highway and 3 km from the sprawling Presidential Park.
              Plush rooms offer free Wi-Fi and flat-screen TVs, plus minibars,
              rainfall showers, and tea and coffeemakers; most have city views
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$91</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$91</p>
              </div>
              <div>
                <Button

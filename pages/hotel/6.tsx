...
const images = [{ url: "/images/hotels/6.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">Rahat Palace Hotel</p>
        <p className="text-black tw-text-md mb-4 text-decoration-underline">
          Almaty, Kazakhstan
        </p>
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[6]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Rahat Palace Hotel is not just a hotel, but a real legend of the
              city of Almaty. It is located in the heart of the Southern capital
              and offers an incredible view of the famous Alatau mountains for
              all guests. Rahat Palace Hotel is the first five-star hotel of
              international level, which was opened in 1996. From the moment of
              its opening to the present day, Rahat Palace is pleased with its
              guests with a high international level of service, impeccable
              service, delicious cuisine and care for every guest.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$115.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$115.5</p>
              </div>
              <div>
                <Button

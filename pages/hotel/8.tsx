...
const images = [{ url: "/images/hotels/8.png" }];
  ...
  return (
    <React.Fragment>
      ...
      <div className="container tw-mt-10 mb-5">
        <p className="text-black tw-text-3xl mb-2">Ramada Almaty Hotel</p>
        <p className="text-black tw-text-md mb-4 text-decoration-underline">
          Almaty, Kazakhstan
        </p>
        <div className="position-relative mt-4 tw-pb-16">
          <img alt="starter-hotel w-100" src={hotelImageService[8]} />
          <SearchBar
            onSubmit={() => {
              return 1;
            }}
        ...
        <div className="row mt-5">
          <div className="col-7">
            ...
            <p className="text-black tw-text-lg tw-mb-4">
              Located just 15 kilometers from Almaty International Airport, our
              Ramada Almaty hotel provides relaxing comfort at an affordable
              price. Our central location makes us a smart choice for business
              trips and when attending events.
            </p>
          ...
          <div className="col-5 px-5">
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <p className="text-black tw-text-md tw-mb-4">$122.5</p>
              </div>
              ...
              <div className="d-flex justify-content-between mt-4">
                ...
                <p className="text-black tw-text-md">$122.5</p>
              </div>
              <div>
                <Button
